...
public interface ProjectMapper {
    ...
    @Select("select project.projname as projname,       COUNT(*) as households,       " +
            "project.price as price,       sum(usewater.amount) as projectNumMonthly,       " +
            "sum(usewater.amount) * project.price as projectPriceMonthly,       " +
            "concat(usewater.year,LPAD(usewater.month,2,0)) as time, project.salesman as salesman from project         " +
